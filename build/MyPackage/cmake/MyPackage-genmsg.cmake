...
message(STATUS "MyPackage: 0 messages, 1 services")
...
get_filename_component(_filename "/home/vm/catkin_ws/src/MyPackage/srv/CustomServMess.srv" NAME_WE)
add_custom_target(_MyPackage_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "MyPackage" "/home/vm/catkin_ws/src/MyPackage/srv/CustomServMess.srv" ""
)
...
_generate_srv_cpp(MyPackage
  "/home/vm/catkin_ws/src/MyPackage/srv/CustomServMess.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/MyPackage)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/MyPackage\")")
  # install generated code
  install(
